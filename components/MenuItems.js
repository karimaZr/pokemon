...
import { FlatList, Modal, StyleSheet, Text, TouchableOpacity, View, Image, SectionList } from 'react-native';
import Icon from 'react-native-vector-icons/FontAwesome';

export default function MenuItems() {
const weaknessColors = ['#EA5D60', '#C70039', '#748FC9', 'red', '#2ECC71', '#F1C40F', '#3498DB', '#8E44AD'];
    ...
    return (
      <Modal visible={modal} animationType='slide'>
        <View style={styles.modalContainer}>
          ...
          <View >{selectedPokemon.weaknesses?.map((weaknesses, i) => (
            <Text key={i} style={[styles.weaknesses, { backgroundColor: weaknessColors[i % weaknessColors.length]  }]}>{weaknesses}</Text>
          ))}
          </View>
  ...
  return (
    <View style={styles.container}>
      ...
      numColumns={2}/> */}
      <Text style={styles.headerText}>Welcome to our world</Text>
